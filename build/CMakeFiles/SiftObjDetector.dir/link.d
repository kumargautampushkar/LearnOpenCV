SiftObjDetector: \
  ...
  /usr/lib64/libarrow_acero.so.2000 \
  ...
  /usr/lib64/libabsl_log_internal_check_op.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_message.so.2508.0.0 \
  /usr/lib64/libabsl_raw_hash_set.so.2508.0.0 \
  /usr/lib64/libabsl_str_format_internal.so.2508.0.0 \
  /usr/lib64/libabsl_hash.so.2508.0.0 \
  /usr/lib64/libabsl_synchronization.so.2508.0.0 \
  /usr/lib64/libabsl_strings.so.2508.0.0 \
  /usr/lib64/libabsl_raw_logging_internal.so.2508.0.0 \
  /usr/lib64/libabsl_spinlock_wait.so.2508.0.0 \
  ...
  /usr/lib64/libabsl_leak_check.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_nullguard.so.2508.0.0 \
  /usr/lib64/libabsl_examine_stack.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_format.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_structured_proto.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_structured_proto.so.2508.0.0 \
  /lib64/libabsl_log_internal_structured_proto.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_structured_proto.so.2508.0.0 \
  /usr/lib64/libabsl_strerror.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_log_sink_set.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_globals.so.2508.0.0 \
  /usr/lib64/libabsl_log_globals.so.2508.0.0 \
  /usr/lib64/libabsl_log_internal_proto.so.2508.0.0 \
  /usr/lib64/libabsl_time.so.2508.0.0 \
  /usr/lib64/libabsl_strings_internal.so.2508.0.0 \
  /usr/lib64/libabsl_throw_delegate.so.2508.0.0 \
  /usr/lib64/libabsl_throw_delegate.so.2508.0.0 \
  /lib64/libabsl_throw_delegate.so.2508.0.0 \
  /usr/lib64/libabsl_throw_delegate.so.2508.0.0 \
  /usr/lib64/libabsl_base.so.2508.0.0 \
  /usr/lib64/libabsl_hashtablez_sampler.so.2508.0.0 \
  /usr/lib64/libabsl_hashtablez_sampler.so.2508.0.0 \
  /lib64/libabsl_hashtablez_sampler.so.2508.0.0 \
  /usr/lib64/libabsl_hashtablez_sampler.so.2508.0.0 \
  /usr/lib64/libabsl_int128.so.2508.0.0 \
  /usr/lib64/libabsl_graphcycles_internal.so.2508.0.0 \
  /usr/lib64/libabsl_kernel_timeout_internal.so.2508.0.0 \
  /usr/lib64/libabsl_stacktrace.so.2508.0.0 \
  /usr/lib64/libabsl_symbolize.so.2508.0.0 \
  /usr/lib64/libabsl_tracing_internal.so.2508.0.0 \
  /usr/lib64/libabsl_malloc_internal.so.2508.0.0 \
  /usr/lib64/samba/libcluster-private-samba.so \
  /usr/lib64/libabsl_log_sink.so.2508.0.0 \
  /usr/lib64/libabsl_log_sink.so.2508.0.0 \
  /lib64/libabsl_log_sink.so.2508.0.0 \
  /usr/lib64/libabsl_log_sink.so.2508.0.0 \
  /usr/lib64/libabsl_time_zone.so.2508.0.0 \
  /usr/lib64/libabsl_debugging_internal.so.2508.0.0 \
  /usr/lib64/libabsl_demangle_internal.so.2508.0.0 \
  /usr/lib64/libabsl_demangle_rust.so.2508.0.0 \
  /usr/lib64/libabsl_decode_rust_punycode.so.2508.0.0 \
  /usr/lib64/libabsl_utf8_for_code_point.so.2508.0.0
